...
set --export FZF_DEFAULT_OPTS '--cycle --layout=reverse --border --height=90% --preview-window=wrap --marker="*" --preview="bat --color=always --style=numbers {}" --bind shift-up:preview-page-up,shift-down:preview-page-down'
# set -x fzf_history_opts '--height=100%'
set -x NEOVIM_WIN_DIR '/mnt/c/tools/neovim/Neovim'
...
# set -x DISPLAY 172.17.80.1:0.0
set -x DISPLAY 172.25.224.1:0.0
...
alias dcompudb='docker-compose up -d --no-deps --build'
...
alias idea "/mnt/c/Program\ Files/JetBrains/IntelliJ\ IDEA\ Community\ Edition\ 2021.1/bin/idea.exe"
